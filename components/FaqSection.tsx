...
export default function FaqSection() {
  ...
  const faqs: FaqItem[] = [
    ...
    { id: 'q-06', code: 'Q06', category: 'TRACKS', question: 'How does track selection and problem statement allocation work?', answer: 'Problem statements across FinTech Open Innovation, Algorithmic Trading, and ZK Systems will be officially released prior to Round 1. Teams select their preferred track during Round 1 submission.' },
