...
class Media {
  extra: number; geometry: any; gl: any; image: string; index: number; length: number; renderer: any; scene: any; screen: any; text: string; viewport: any; bend: number; textColor: string; borderRadius: number; font: string; program: any; plane: any; title: any; speed: number; isBefore: boolean; isAfter: boolean; scale: number; padding: number; width: number; widthTotal: number; x: number;
  constructor({
...
class App {
  ...
  update() {
    ...
    try {
      ...
      console.warn("CircularGallery WebGL render error:", e);
    }
