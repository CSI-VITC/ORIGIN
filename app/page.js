...
export default function Home() {
  ...
  useEffect(() => {
    ...
    hideStyle.textContent = '.home-news, .home-contact-form { display: none !important; }';
  ...
  if (!mounted) {
    return <div style={{ backgroundColor: '#05070D', minHeight: '100vh' }} />;
  }
  return (
    <>
        <SplineHero />
        <div id="__nuxt">
            ...
            <header>
                ...
                <div className="wrapper">
                    ...
                    <div className="right"><a href="/work" className="font-12-dark"> The Origin </a><a href="/our-story"
                            className="font-12-dark"> The Journey </a><a className="font-12-dark"
                            href="/arena"> The Arena </a><a href="/insights" className="font-12-dark">
                            The Rewards </a><a href="/connect" className="font-12-dark"> Launch </a></div>
            ...
            <div className="mobile-menu">
                <div className="mobile-links"><a href="/work" className="font-12-dark"><span>The Origin</span></a><a
                        href="/our-story" className="font-12-dark"><span>The Journey</span></a><a
                        className="font-12-dark" href="/arena"><span>The Arena</span></a><a
                        href="/insights" className="font-12-dark"><span>The Rewards</span></a><a href="/connect"
                        className="font-12-dark"><span>Launch</span></a></div>
            ...
            <div className="index-page">
                <div className="on-touch home-page-wrapper" id="smooth-wrapper"
                        ...
                        <div className="home-page">
                            <div data-v-1d267d81="" className="mobile-hero">
                                <div data-v-1d267d81="" className="wrapper">
                                    <h1 data-v-1d267d81=""> Every origin story begins with an idea that refuses to stay
                                        small. </h1>
                                    <h2 data-v-1d267d81="">CSI ORIGIN is a 36-hour hackathon where students build the future
                                        from a single idea - a weekend that turns curiosity into craft, and craft into a
                                        story worth telling.</h2>
                                </div>
                            </div>
                            ...
                            <div className="mobile-rev">
                                <div className="wrapper">
                                    <h2 className="font-machina-60"> EVERY BREAKTHROUGH BEGINS WITH PEOPLE. </h2>
                                    <p className="desc font-neue-roman-16"> ORIGIN isn’t built by an agency — it’s
                                        assembled by the people who stayed late, answered the tricky email, and chose to
                                        believe a hackathon can be cinematic. </p>
                                    <p className="font-neue-roman-16"> Six voices shaped this event: faculty who guided,
                                        leads who carried the load, and a committee that refused to let the idea die
                                        quietly. </p>
                                </div>
                                <div
                                    ...
                                    <div className="swiper-wrapper"
                                        ...
                                        <div className="swiper-slide swiper-slide-active slide" style={{"marginRight":"15px"}}>
                                            ...
                                            <div>
                                                <div className="company"><img alt="logo" src="/mobileRev/origin-logo.png" /></div>
                                                <p className="desc font-neue-roman-16"> “Mentorship shapes the kind of
                                                    builders students become. We hold space for curiosity and rigor in
                                                    equal measure — guiding without dictating, so every idea gets the
                                                    room it deserves.” </p>
                                            </div>
                                            <div>
                                                <p className="name font-12-dark">Faculty Coordinator</p>
                                                <p className="position font-14-dark">[Faculty Name]<br />Faculty Coordinator, CSI</p>
                                            </div>
                                        </div>
                                        <div className="swiper-slide swiper-slide-next slide" style={{"marginRight":"15px"}}>
                                            ...
                                            <div>
                                                <div className="company"><img alt="logo" src="/mobileRev/origin-logo.png" /></div>
                                                <p className="desc font-neue-roman-16"> “An event is only as alive as the
                                                    people running it. We move between details and atmosphere, keeping
                                                    energy high, friction low, and every participant seen.” </p>
                                            </div>
                                            <div>
                                                <p className="name font-12-dark">Student Coordinator</p>
                                                <p className="position font-14-dark">[Coordinator Name]<br />Student Coordinator, CSI</p>
                                            </div>
                                        </div>
                                        <div className="swiper-slide slide" style={{"marginRight":"15px"}}>
                                            <div>
                                                <div className="company"><img alt="logo" src="/mobileRev/origin-logo.png" /></div>
                                                <p className="desc font-neue-roman-16"> “Behind every smooth demo stands a
                                                    stack that refused to fall over. We engineer reliability so the
                                                    audience sees only the magic, never the seams.” </p>
                                            </div>
                                            <div>
                                                <p className="name font-12-dark">Technical Lead</p>
                                                <p className="position font-14-dark">[Tech Lead Name]<br />Technical Lead, ORIGIN</p>
                                            </div>
                                        </div>
                                        <div className="swiper-slide slide" style={{"marginRight":"15px"}}>
                                            <div>
                                                <div className="company"><img alt="logo" src="/mobileRev/origin-logo.png" /></div>
                                                <p className="desc font-neue-roman-16"> “Visual language is a silent
                                                    narrator. We craft systems where type, space, and color argue the
                                                    case before a single word is read.” </p>
                                            </div>
                                            <div>
                                                <p className="name font-12-dark">Design Lead</p>
                                                <p className="position font-14-dark">[Design Lead Name]<br />Design Lead, ORIGIN</p>
                                            </div>
                                        </div>
                                        <div className="swiper-slide slide" style={{"marginRight":"15px"}}>
                                            <div>
                                                <div className="company"><img alt="logo" src="/mobileRev/origin-logo.png" /></div>
                                                <p className="desc font-neue-roman-16"> “A 36-hour hackathon is theatre,
                                                    logistics, and therapy in one. We orchestrate the chaos so teams
                                                    stay inside the work that matters.” </p>
                                            </div>
                                            <div>
                                                <p className="name font-12-dark">Event Lead</p>
                                                <p className="position font-14-dark">[Event Lead Name]<br />Event Lead, ORIGIN</p>
                                            </div>
                                        </div>
                                        <div className="swiper-slide slide" style={{"marginRight":"15px"}}>
                                            <div>
                                                <div className="company"><img alt="logo" src="/mobileRev/origin-logo.png" /></div>
                                                <p className="desc font-neue-roman-16"> “ORIGIN is not the work of any single
                                                    office. It is the accumulated belief of a community that decided the
                                                    next breakthrough is worth betting on.” </p>
                                            </div>
                                            <div>
                                                <p className="name font-12-dark">CSI Organizing Committee</p>
                                                <p className="position font-14-dark">[Coordinator Name]<br />CSI Organizing Committee</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="home-awards-list">
                                <div className="wrapper">
                                    <h3 className="font-machina-60">Six tracks. 36 hours. Build the future from a single idea.</h3>
                                    <div className="items-list">
                                        <div className="item-id-ai item home-a-item">
                                            <div className="top-line"></div>
                                            <div className="bottom-line"></div>
                                            <p className="font-neue-roman-24 name">AI &amp; Machine Learning</p>
                                            <p className="count font-neue-roman-14-500">/ 03</p><img className="arrow"
                                                alt="arrow" src="/icons/linkArrow.svg" />
                                            <div className="aw-list-ai aw-list">
                                                ...
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Neural Origins<span
                                                            className="only-mobile"> - Machine Learning</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Machine Learning</p>
                                                    <p className="font-neue-roman-24 s-year">01</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Prompt to Product<span
                                                            className="only-mobile"> - Generative AI</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Generative AI</p>
                                                    <p className="font-neue-roman-24 s-year">02</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Vision &amp; Voice<span
                                                            className="only-mobile"> - Applied AI</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Applied AI</p>
                                                    <p className="font-neue-roman-24 s-year">03</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="item-id-cybersecurity item home-a-item">
                                            <div className="top-line"></div>
                                            <div className="bottom-line"></div>
                                            <p className="font-neue-roman-24 name">Cybersecurity &amp; Ethical Hacking</p>
                                            <p className="count font-neue-roman-14-500">/ 03</p><img className="arrow"
                                                alt="arrow" src="/icons/linkArrow.svg" />
                                            <div className="aw-list-cybersecurity aw-list">
                                                <div className="list-item top-titles">
                                                    <p className="s-name">Project</p>
                                                    <p className="s-nomination">Nomination</p>
                                                    <p className="s-year">Year</p>
                                                ...
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Firewall Fury<span
                                                            className="only-mobile"> - Capture The Flag</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Capture The Flag</p>
                                                    <p className="font-neue-roman-24 s-year">01</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Zero Trust Build<span
                                                            className="only-mobile"> - Security Architecture</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Security Architecture</p>
                                                    <p className="font-neue-roman-24 s-year">02</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Digital Forensics<span
                                                            className="only-mobile"> - Investigation</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Investigation</p>
                                                    <p className="font-neue-roman-24 s-year">03</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="item-id-blockchain item home-a-item">
                                            <div className="top-line"></div>
                                            <div className="bottom-line"></div>
                                            <p className="font-neue-roman-24 name">Blockchain &amp; Web3</p>
                                            <p className="count font-neue-roman-14-500">/ 03</p><img className="arrow"
                                                alt="arrow" src="/icons/linkArrow.svg" />
                                            <div className="aw-list-blockchain aw-list">
                                                <div className="list-item top-titles">
                                                    <p className="s-name">Project</p>
                                                    <p className="s-nomination">Nomination</p>
                                                    <p className="s-year">Year</p>
                                                ...
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Chain Craft<span
                                                            className="only-mobile"> - Smart Contracts</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Smart Contracts</p>
                                                    <p className="font-neue-roman-24 s-year">01</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">DeFi Dash<span
                                                            className="only-mobile"> - Decentralized Finance</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Decentralized Finance</p>
                                                    <p className="font-neue-roman-24 s-year">02</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">NFT Narratives<span
                                                            className="only-mobile"> - Web3 Experiences</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Web3 Experiences</p>
                                                    <p className="font-neue-roman-24 s-year">03</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="item-id-webdev item home-a-item">
                                            <div className="top-line"></div>
                                            <div className="bottom-line"></div>
                                            <p className="font-neue-roman-24 name">Web Development</p>
                                            <p className="count font-neue-roman-14-500">/ 03</p><img className="arrow"
                                                alt="arrow" src="/icons/linkArrow.svg" />
                                            <div className="aw-list-webdev aw-list">
                                                <div className="list-item top-titles">
                                                    <p className="s-name">Project</p>
                                                    <p className="s-nomination">Nomination</p>
                                                    <p className="s-year">Year</p>
                                                ...
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Pixel Perfect<span
                                                            className="only-mobile"> - Frontend Craft</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Frontend Craft</p>
                                                    <p className="font-neue-roman-24 s-year">01</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Full-Stack Fusion<span
                                                            className="only-mobile"> - Architecture &amp; Backend</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Architecture &amp; Backend</p>
                                                    <p className="font-neue-roman-24 s-year">02</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Velocity Sprint<span
                                                            className="only-mobile"> - Performance &amp; SEO</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Performance &amp; SEO</p>
                                                    <p className="font-neue-roman-24 s-year">03</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="item-id-spacetech item home-a-item">
                                            <div className="top-line"></div>
                                            <div className="bottom-line"></div>
                                            <p className="font-neue-roman-24 name">SpaceTech</p>
                                            <p className="count font-neue-roman-14-500">/ 03</p><img className="arrow"
                                                alt="arrow" src="/icons/linkArrow.svg" />
                                            <div className="aw-list-spacetech aw-list">
                                                <div className="list-item top-titles">
                                                    <p className="s-name">Project</p>
                                                    <p className="s-nomination">Nomination</p>
                                                    <p className="s-year">Year</p>
                                                ...
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Orbit Builders<span
                                                            className="only-mobile"> - Satellites &amp; Rovers</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Satellites &amp; Rovers</p>
                                                    <p className="font-neue-roman-24 s-year">01</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Deep Space Dev<span
                                                            className="only-mobile"> - Mission Software</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Mission Software</p>
                                                    <p className="font-neue-roman-24 s-year">02</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Ground Station<span
                                                            className="only-mobile"> - Data &amp; Telemetry</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Data &amp; Telemetry</p>
                                                    <p className="font-neue-roman-24 s-year">03</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="item-id-iot item home-a-item">
                                            <div className="top-line"></div>
                                            <div className="bottom-line"></div>
                                            <p className="font-neue-roman-24 name">IoT &amp; Robotics</p>
                                            <p className="count font-neue-roman-14-500">/ 03</p><img className="arrow"
                                                alt="arrow" src="/icons/linkArrow.svg" />
                                            <div className="aw-list-iot aw-list">
                                                <div className="list-item top-titles">
                                                    <p className="s-name">Project</p>
                                                    <p className="s-nomination">Nomination</p>
                                                    <p className="s-year">Year</p>
                                                ...
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Smart Sensors<span
                                                            className="only-mobile"> - IoT Networks</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">IoT Networks</p>
                                                    <p className="font-neue-roman-24 s-year">01</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Robot Rumble<span
                                                            className="only-mobile"> - Robotics &amp; Automation</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Robotics &amp; Automation</p>
                                                    <p className="font-neue-roman-24 s-year">02</p>
                                                </div>
                                                <div className="list-item">
                                                    <p className="font-neue-roman-24 s-name">Edge Impulse<span
                                                            className="only-mobile"> - Embedded Systems</span></p>
                                                    <p className="font-neue-roman-24 s-nomination">Embedded Systems</p>
                                                    <p className="font-neue-roman-24 s-year">03</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="slide-wrapper"><img alt="image" loading="lazy"
                                                src="/tracks/ai/preview.webp" style={{"opacity":"0"}} /><img alt="image" loading="lazy"
                                                src="/tracks/cybersecurity/preview.webp" style={{"opacity":"0"}} /><img alt="image" loading="lazy"
                                                src="/tracks/blockchain/preview.webp" style={{"opacity":"0"}} /><img alt="image" loading="lazy"
                                                src="/tracks/webdev/preview.webp" style={{"opacity":"0"}} /><img alt="image" loading="lazy"
                                                src="/tracks/spacetech/preview.webp" style={{"opacity":"0"}} /><img alt="image" loading="lazy"
                                                 src="/tracks/iot/preview.webp" style={{"opacity":"0"}} /></div>
                                     </div>
                                     <div className="more">
                                        <p className="">+ 6 tracks · 36 hours · one ORIGIN</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="testimonails-text"
                        ...
                        <div className="wrapper">
                            <div className="texts">
                                <p className="font-neue-roman-18">ORIGIN isn't built by an agency — it's assembled by the
                                    people who stayed late, answered the tricky email, and chose to believe a hackathon
                                    can be cinematic. The team below is the full cast: faculty mentors, student leads,
                                    designers, engineers, and the organizing committee that turns a theme into a working
                                    universe. This is the room the work comes out of.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="hero-text"
                        style={{"translate":"none","rotate":"none","scale":"none","transform":"translate(0px, 0px)","opacity":"1","color":"#fff"}}>
                        <h1 style={{"color":"#fff"}}> Every origin story begins with an idea that refuses to stay small. </h1>
                        <p style={{"color":"#fff"}}><span style={{"color":"#fff"}}>CSI ORIGIN is a 36-hour hackathon where students build the future from a single idea - a
                                weekend that turns curiosity into craft, and craft into a story worth telling.</span></p>
                    </div>
